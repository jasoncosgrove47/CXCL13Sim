...
public class Vector3DHelper
{
	...
	{
		// TODO which is faster? this one has less calcs, but one more random call - I suspect this is slower
		// see http://mathworld.wolfram.com/SpherePointPicking.html at the bottom
	...
	/**
	 * Generates a uniform random point on the surface of the unit sphere within a specified cone
	 * @param d3Direction The unit vector at the centre of the cone
	 * @param dConeAngle The total angle of the cone
	 * @return A unit vector for a random direction in the cone
	 */
	public static Double3D getRandomDirectionInCone(Double3D d3Direction, double dConeAngle)
	{
		// see http://math.stackexchange.com/a/205589
		
		// Basically the surface area of a sphere has a 1-1 relationship with the curved surface of a
		// cylinder. A vertical section of either with the same height has the same surface area
		// So what we do is pick a random point on a cylinder with height between
	 ...
	 * @return A unit vector for a random direction in the cone
	 */
	public static Double3D getBiasedRandomDirectionInCone(Double3D d3Direction, double dConeAngle)
	{
		// see getRandomDirectionInCone
	...
	public static Double3D rotateUsingVector(Double3D d3Point, Double3D d3Direction)
	{
		...
		double a = (1-dotProduct(new Double3D(0,0,1), d3Direction))/(d3Cross.length()*d3Cross.length());
	 ...
	 * @param d3Vector The vector to rotate
	 * @param dTheta The angle to rotate
	 * @return The rotated vector
	 */
