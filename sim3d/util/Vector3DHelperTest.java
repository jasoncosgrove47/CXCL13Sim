...
public class Vector3DHelperTest {
	...
	//This function should return a random point on the surface of a r=1 sphere. The distribution of 
	//points across the surface of the sphere should be even. In particular, there should be no 
	//grouping in the corners or at the poles - which is common with incorrect algorithms.
	//plots 50000 points returned from the function, and displays the result. 
	//The resulting graph can be seen in ./Test01.png. As can be seen, the point on 
