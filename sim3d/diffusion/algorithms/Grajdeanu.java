...
{
	/**
	 * Initialise the class and set the diffusion coefficients for the DiffusionAlgorithm parent
	 * @param dDiffusionCoefficient The parameter for the diffusion
	...
	/**
	 * Sets the diffusion coefficients of the parent using the diffusion coefficient
	 * @param dDiffuseCoeff The diffusion coefficient to use
	 */
